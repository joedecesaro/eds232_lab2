...
**Question:** Question: Which function comes first, vegdist() or hclust(), and why? See HOMLR 21.3.1 Agglomerative hierarchical clustering.
...
- agnes() performs agglomerative hierarchical clustering and computes an agglomerative coefficient. diana() performs divisive hierarchical clustering and computes a divisive coefficient (closer to one suggests stronger group distinctions).
...
**Question:** Question: How do the optimal number of clusters compare between methods for those with a dashed line?
